...
int main() 
{
	...
	switch(list) 
	{
		case 1: segitiga_sembarang(); perulangan(); break;
		case 2: belah_ketupat(); perulangan(); break;
		case 3: jajar_genjang(); perulangan(); break;
		case 4: trapesium(); perulangan(); break;
		case 5: lingkaran(); perulangan(); break;
