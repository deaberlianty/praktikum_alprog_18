...
{	
	...
	switch(list) {
		case 1: tabung(); perulangan(); break; 
		case 2: bola(); perulangan(); break;
		case 3: limas_segiempat(); perulangan(); break;
		case 4: prisma_segitiga(); perulangan(); break;
		case 5: kerucut(); perulangan(); break;
